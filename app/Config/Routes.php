...
$routes->get('/detail/', 'UserController::Single_produk');
...
$routes->get('/invoice/', 'UserController::Invoice');
$routes->get('/login/','AuthController::login/2');
$routes->get('/register/','UserController::Register');
$routes->get('/myorder/','UserController::Order_list');
$routes->get('/myprofile/','UserController::Profile');
$routes->get('/editprofile/','UserController::Edit_profile');
$routes->get('/editpass/','UserController::Edit_pass');
